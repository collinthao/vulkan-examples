...
class DirectionalLight : public IVulkanApp
{
	public:
	...
	void setupCubePipeline()
	{
		...
		addShader(SHADER_DIRECTORY + "/directionalLight/frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT);	
	...
	void recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
	{
		...
		vkCmdDrawIndexed(commandBuffer, static_cast<uint32_t>(DirectionalLight::cubeIndices.size()), 1, 0, 0, 0);

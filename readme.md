...
- make vulkanRenderer have a dependency injection for VkApp instead of a static implementation. This will allow switching applications seamlessly and not having to write all code in one class
